...
public class UpdateLocationClass {
    private ArrayList<CarInfoClass> carInfoClasses;
    public ArrayList<CarInfoClass> getUpdates(int branchId) {
        String methodName = "GetLocationUpdates";
        ...
        if (!isUrlMalformed) {
            try {
                ...
                httpURLConnection.setRequestProperty("SOAPAction", "http://tempuri.org/GetLocationUpdates");
                String sendData = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" +
                        "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">\n" +
                        "  <soap:Body>\n" +
                        "     <GetLocationUpdates xmlns=\"http://tempuri.org/\">\n" +
